...
{0x3103, 0x11},
	...
	{0x3a13, 0x43},
	{0x3a18, 0x00},
	{0x3a19, 0x7f}, //analog gain 0xf8: 15.5x, 0x7f: 8x, 0x3f: 4x
	{0x3635, 0x1c},
	{0x3634, 0x40},
	{0x3622, 0x01},
	{0x3c01, 0x34},
	...
	{0x583c, 0x2e},
	{0x583d, 0xce},
	//Night mode enable, 10fps setting
	{0x3a00, 0x7c},
	{0x3a02, 0x0b},
	{0x3a03, 0x88},
	{0x3a14, 0x0b},
...
{0x3503, 0x00},
	...
	*/
	...
	{0x5001, 0xA3},
	{0x3008, 0x02},
//{0x4800, 0x34}, //+ NV's Arthur//Bill: move forward
	#if 1
	//{0x3035, 0x14},
	{0x3035, 0x11},
	{0x3821, 0x06},
	...
	{0x3003, 0x03},
	{0x3003, 0x01},
	{0x4300, 0x32}, //+ NV's Arthur
{0x4800, 0x34}, //+ NV's Arthur
{SENSOR_WAIT_MS, 100}, //Bill
{0x4837, 0x09},
//{SENSOR_WAIT_MS, 100}, //Bill
	{SENSOR_TABLE_END, 0x0000},
};
...
static int __init tegra_i2c_debuginit(void)
{
	...
	(void) debugfs_create_file("i2c_set", S_IRUGO,
